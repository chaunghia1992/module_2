...
public class PaymentView {
    ...
    public void pay() {
        ...
        System.out.println("∘∘∘∘∘∘∘∘∘∘∘∘∘∘∘∘∘∘∘∘∘∘∘∘∘∘∘∘∘∘∘∘∘∘∘∘∘∘∘∘");
        System.out.println("Nhập họ và tên (vd: Châu Văn Nghĩa) ");
        System.out.print("\t➺ ");
        ...
        while (!ValidateUtils.isNameValid(name)) {
            ...
            System.out.println("Nhập tên (vd: Văn Nghĩa) ");
            System.out.print("\t➺ ");
            name = scanner.nextLine();
        }
        System.out.println("Nhập số điện thoại (vd: 0362744852): ");
        System.out.print("\t➺ ");
        ...
        System.out.println("Nhập địa chỉ (vd:  TP Huế)");
        System.out.print("\t➺ ");
